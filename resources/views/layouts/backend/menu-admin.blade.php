<ul class="nav nav-pills nav-sidebar flex-column" data-accordion="false" data-widget="treeview" role="menu">
    ...
    <li class="nav-item has-treeview">
        <a class="nav-link " href="#"><i class="nav-icon far fa-user"></i><p>User<i class="right fa fa-angle-left"></i> </p></a>
        <ul class="nav nav-treeview" style="display: none;">
            <li class="nav-item">
                <a class="nav-link" href="<?= url('/user-user/index?id_user_role=1'); ?>">
                    <i class="nav-icon far fa-circle"></i>  <p>Admin</p>
                </a>
            </li>
            <li class="nav-item"><a class="nav-link" href="<?= url('/user-user/index?id_user_role=2'); ?>"><i class="nav-icon far fa-circle"></i>  <p>Pasien</p></a></li>
            <li class="nav-item"><a class="nav-link" href="<?= url('/user-user/index?id_user_role=3'); ?>"><i class="nav-icon far fa-circle"></i>  <p>Faskes</p></a></li>
            <li class="nav-item"><a class="nav-link" href="<?= url('/user-user/index?id_user_role=4'); ?>"><i class="nav-icon far fa-circle"></i>  <p>Dokter</p></a></li>
        </ul>
    </li>
