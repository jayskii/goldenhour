...
class Helper
{
    ...
    public static function getWaktu($waktu)
    {
        if ($waktu == '')
            return null;
        else {
            ...
            $output = $hari . ', ' . $tgl . ' ' . $bulan . ' ' . $tahun . ' | ' . $pukul;

            return $output;
        }
    }

    public static function persen(int $sudah, int $total)
    {
        if($total == null) {
            return 100;
        }

        return round($sudah/$total * 100);
    }

    public static function getHari($h = null)
    {
        if ($h == '1') {
            return 'Senin';
        } elseif ($h == '2') {
